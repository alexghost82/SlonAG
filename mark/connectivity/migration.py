...
if TYPE_CHECKING:
    from mark.connectivity.session import ConnectivitySession
...
class LANRemoteMigration:
    ...
    async def migrate_to_remote(self, reason: str = "lan_lost") -> None:
        ...
        """
        from mark.connectivity.session import ConnectivitySessionError
        ...
        try:
            ...
            if self._session._remote_adapter is None:
                from mark.connectivity.remote import RemoteAdapter
    ...
    async def migrate_to_lan(
        ...
        """
        from mark.connectivity.session import ConnectivitySessionError
        from mark.connectivity.transport import LANTransport, TransportConfig
    ...
    async def find_best_lan_device(self) -> Any:
        ...
        """
        from mark.connectivity.discovery import LANDeviceScanner
