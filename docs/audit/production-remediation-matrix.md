...
**Wave progress:** R0 `95f2f74`. R1 `d104c1c`. R2 `1813960`. R3 `20c0b1c`. R4 in progress — canonical SQLite memory + provenance; Live path off JSON writes. SlonLive still Gemini transport until R7.
