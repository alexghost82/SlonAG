# Агент 14 — LAN / Remote Connectivity
...
Довести connectivity/iOS transport foundation.
...
- `mark/connectivity/**`
- connectivity-specific files under `ios/**`
- tests

Не менять Gateway auth internals.
...
- authenticated TLS;
- session continuity;
- LAN/remote transition;
- no raw media through Firebase;
...
- LAN path использует authenticated TLS/WSS.
- Нет неявного insecure fallback.
