# Агент 08 — Controlled Self-Improvement
...
Довести `mark/selfimprovement` до безопасного production pipeline.

## Зона владения

Только:

- `mark/selfimprovement/**`
- tests
...
Self-improvement никогда не может:

- ослаблять authentication;
- ослаблять approval;
- отключать permission checks;
- увеличивать network exposure;
- сохранять secrets;
- самовольно менять security policy.
...
- Любое изменение обратимо.
- Security boundaries невозможно ослабить через self-improvement pipeline.
